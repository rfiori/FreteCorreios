<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Test_FreteCorreios.Default" %>
...
<body>
    <form id="form1" runat="server" style="font-family:'Arial Narrow', Arial, sans-serif;">
        <div style="padding:10px; line-height:34px; border: solid 2px #494949; border-radius:5px;">
            ...
            &nbsp;Valor declarado(R$)&nbsp; -&nbsp; 0 para não declarado<br />
            <br />
            <asp:Button ID="btnGetWS" runat="server" OnClick="btnGetWS_Click" Text="Get Webservices" />
            <br />
            <br />
            <span style="line-height:19px;">
                <asp:Label ID="lblRes1" runat="server" Width="100%" Font-Size="15px" BackColor="#FFCC99"></asp:Label>
            </span>
        </div>
    </form>
</body>
